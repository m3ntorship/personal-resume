    ...
    return (
      <header className=" w-full pb-48 relative">
       <div
          ...
          className="hidden lg:block z-10 absolute top-0 left-0 w-full h-full bg-c400 "
        ></div>
        <div
          style={{ clipPath: 'polygon(0 0, 100% 0, 55% 100%, 0 100%)' }}
          className="hidden lg:block z-0 absolute top-0 left-0 w-full h-full bg-c100 opacity-25"
        ></div>
